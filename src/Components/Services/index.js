...
const Services = () => {
    return (
      <ServicesContainer id="services">
        ...
        <ServicesP2>
          Y+M popular Standalone courses go for Ugx.360,000 for 4 weeks while the Full course
          goes for Ugx. Ugx.980,000 with flexible paying plans. 
          All girls qualify for the SheCanCode program which offers them our Standalone course at
          Ugx.280,000 and Full course at Ugx. 720,000 respectively. 
